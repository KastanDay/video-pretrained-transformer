...
# hyperparams 
MODEL_VERSION_NAME  = 'gpt2_yt_pretrain_adamW_1e-3'
BATCH_NAME          = "parallel_15"
learning_rate       = 1e-3  # also good: 3e-4
...
if os.path.exists(MODEL_SAVE_PATH):
    ...
    t5 = GPT2LMHeadModel.from_pretrained("gpt2").to(device)
    ...
    t5 = GPT2LMHeadModel.from_pretrained("gpt2").to(device)
t5_tokenizer = GPT2Tokenizer.from_pretrained("gpt2")
